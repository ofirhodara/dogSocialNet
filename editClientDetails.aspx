<%@ Page Title="" Language="C#" MasterPageFile="~/MasterShon.master" AutoEventWireup="true" CodeFile="editClientDetails.aspx.cs" Inherits="editClientDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="w3-sand w3-grayscale w3-large"><br /><br /><br /><br />
       
        <center> <h1 class="w3-center w3-padding-64"><span class="w3-tag w3-wide">עריכת פרטי לקוח</span></h1></center>
